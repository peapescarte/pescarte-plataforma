  ...
  def entries do
    [
      %Usuario{
        ...
        cpf: "13359017790",
        contato_id: "zoey.spessanha@outlook.com",
        tipo: :admin
      },
      %Usuario{
        id: Nanoid.generate_non_secure(),
      ...
      %Usuario{
        ...
        cpf: "01424681693",
        contato_id: "giselebragabastos.pescarte@gmail.com",
        tipo: :admin
      },
      %Usuario{
        id: Nanoid.generate_non_secure(),
        ...
        confirmado_em: ~N[2023-06-23 03:43:08],
        cpf: "55390153634",
        contato_id: "geraldotimoteo@gmail.com",
        tipo: :pesquisador
      },
      %Usuario{
        id: Nanoid.generate_non_secure(),
        ...
        confirmado_em: ~N[2023-06-23 03:43:08],
        cpf: "21452123888",
        contato_id: "sahudy.montenegro@gmail.com",
        tipo: :admin
      }
    ]
  end
