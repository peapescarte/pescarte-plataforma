defmodule FuschiaWeb.Endpoint do
  ...
  plug Plug.Static,
    ...
    from: :fuschia,
    gzip: false,
    only: ~w(assets fonts images favicon.ico apple-touch-icon.png favicon-32x32.png favicon-16x16.png safari-pinned-tab.svg browserconfig.xml service_worker.js cache_manifest.json manifest.json)
