defmodule Pescarte.CotacoesETL.Handlers.PesagroHandler do
  import Pescarte.CotacoesETL.Integrations

  alias Pescarte.Cotacoes.Handlers.CotacaoHandler
  alias Pescarte.CotacoesETL.Handlers.IManagePesagroHandler
