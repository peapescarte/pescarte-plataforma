defmodule Pescarte.CotacoesETL.Workers.PDFConverter do
  @moduledoc """
  ...
  import Pescarte.CotacoesETL.Handlers, only: [pdf_converter_handler: 0]

  alias Pescarte.CotacoesETL.Events.ConvertPDFEvent
  alias Pescarte.CotacoesETL.Events.PDFConvertedEvent
