defmodule ModuloPesquisa.Models.RelatorioMensalPesquisa do
  use Database, :model

  alias ModuloPesquisa.Models.Pesquisador

  @type t :: %RelatorioMensalPesquisa{
  ...
  @spec changeset(RelatorioMensalPesquisa.t(), map) :: changeset
  def changeset(%RelatorioMensalPesquisa{} = relatorio_mensal, attrs) do
    relatorio_mensal
