defmodule Cotacoes.IManageRepository do
  ...
  @callback insert_all_cotacao(list(Cotacao.t())) :: {:ok, list(Cotacao.t()) | nil}
  @callback list_cotacao :: list(Cotacao.t())
  @callback update_all_cotacao(list(Cotacao.t())) :: {:ok, list(Cotacao.t()) | nil}
  ...
  @callback insert_all_pescado(list(Pescadot.t())) :: {:ok, list(Pescado.t()) | nil}
